  ...
  <div class="demo-vsteper-container">
    ...
    <mu-stepper :activeStep="activeStep" orientation="vertical">
      <mu-step>
        <mu-step-label>
          学习
          <a target="_blank" href="http://www.runoob.com/html/html-tutorial.html">HTML</a>
        </mu-step-label>
        <mu-step-content>
          <p>
      ...
      <mu-step>
        <mu-step-label>
          学习
          <a target="_blank" href="http://www.runoob.com/css/css-tutorial.html">CSS</a>
        </mu-step-label>
        <mu-step-content>
          <p>
      ...
      <mu-step>
        <mu-step-label>
          学习
          <a target="_blank" href="http://www.runoob.com/js/js-tutorial.html">Javascript</a>
        </mu-step-label>
        <mu-step-content>
          <p>
      ...
      <mu-step>
        <mu-step-label>
          学习
          <a target="_blank" href="http://www.muse-ui.org/#/index">Muse-UI</a>
        </mu-step-label>
        <mu-step-content>
          <p>
      ...
      <mu-step>
        <mu-step-label>
          完成
          <a target="_blank" href="https://github.com/kessil/exam_assistant">考试助手</a>
        </mu-step-label>
        <mu-step-content>
          <p>
            信号工苦，信号工累，信号工还要答题对。信号工考试助手神器在手，答题再也不累！
          </p>
    ...
    <h3 v-if="finished" class="finished">
      都完成啦!
      <a href="javascript:;" @click="reset">再看一遍</a>
      <div v-if="false">
        <p>支持配置题库，替换文件"../data.json"，要求json格式如下:</p>
        <img :src="dataExampleImg.src" :alt="dataExampleImg.name" :title="dataExampleImg.name" width="100%">
      </div>
    </h3>
  </div>
</template>
...
export default {
  data() {
    return {
      activeStep: 0,
      dataExampleImg: { name: "题库文件格式", src: require('../assets/data.png') },
      linkerImg: [
